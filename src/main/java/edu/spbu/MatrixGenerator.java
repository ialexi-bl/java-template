...
public class MatrixGenerator {
  ...
  private static void testPerformance() {
    ...
    /*
     * System.out.println("Starting loading dense matrices"); Matrix m1 = new
     * DenseMatrix(MATRIX1_NAME); System.out.println("1 loaded"); Matrix m2 = new
     * DenseMatrix(MATRIX2_NAME); System.out.println("2 loaded"); long start =
     * System.currentTimeMillis(); m1.mul(m2);
     * System.out.println("Dense Matrix time: " +(System.currentTimeMillis() -
     * start));
     * 
     * System.out.println("Starting loading sparse matrices"); m1 = new
     * SparseMatrix(MATRIX1_NAME); System.out.println("1 loaded"); m2 = new
     * SparseMatrix(MATRIX2_NAME); System.out.println("2 loaded"); start =
     * System.currentTimeMillis(); m1.mul(m2);
     * System.out.println("Sparse Matrix time: " +(System.currentTimeMillis() -
     * start));
     */
  }
